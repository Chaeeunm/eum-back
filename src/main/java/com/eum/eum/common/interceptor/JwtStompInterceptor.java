package com.eum.eum.common.interceptor;
			...
			case CONNECT:
				...
				try {
					...
					if (accessToken == null || !jwtTokenProvider.validateToken(accessToken)) {
						throw new RestException(ErrorCode.INVALID_TOKEN, accessToken);
					}
					...
					if (meetingId == null)
						throw new RestException(ErrorCode.INVALID_INPUT, "meetingId를 입력해주세요");
